...
linear_model.seq.show_forward_propagation_process = True
prediction = linear_model.predict_for_single_data_point(dp)

print("\n\n\n\n")
print("The is FNN")
FNN_model.fit(df80)
FNN_model.seq.show_forward_propagation_process = True
FNN_model.predict_for_single_data_point(dp)

print("\n\n\n\n")
print("The is AE")
AE_model.fit(df80)
AE_model.seq.show_forward_propagation_process = True
AE_model.predict_for_single_data_point(dp)
